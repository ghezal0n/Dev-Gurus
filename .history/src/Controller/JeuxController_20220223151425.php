...
class JeuxController extends AbstractController
{
    ...
    {
        return $this->render('frontend/jeux/afficherjeux.html.twig', [
            'controller_name' => 'JeuxController',
        ]);
    }
        ...
        if($form->isSubmitted()&& $form->isValid())
{
    ...
    return $this->render('backend/jeux/ajouter.html.twig',[
        'jeux' => $jeux,
    ...
    {
        $jeux=$repository->findAll();
        return $this->render('frontend/jeux/afficher.html.twig',['jeux'=>$jeux]);
    }
