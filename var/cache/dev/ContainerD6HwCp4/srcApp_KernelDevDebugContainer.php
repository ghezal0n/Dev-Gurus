...
class srcApp_KernelDevDebugContainer extends Container
{
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('5wQAqk8+oH', 0, ($this->targetDir.''.'/pools'), new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL));
    ...
    {
        return $this->services['cache.system'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('tiHZVZ7BeO', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.annotations'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('0ZtdhL1WDW', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.property_info'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('nB4yUX38ui', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.security_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('DM1dSZu5mz', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('E5TQ0gJOaL', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('+Wpm4axEvK', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
...
class EntityManager_9a5be93 extends \Doctrine\ORM\EntityManager implements \ProxyManager\Proxy\VirtualProxyInterface
{
     ...
     */
    private $valueHolder5f165 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializerf0514 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties46b5a = [
        
    ];

    public function getConnection()
    {
        $this->initializerf0514 && ($this->initializerf0514->__invoke($valueHolder5f165, $this, 'getConnection', array(), $this->initializerf0514) || 1) && $this->valueHolder5f165 = $valueHolder5f165;

        return $this->valueHolder5f165->getConnection();
    }

    public function getMetadataFactory()
    {
        $this->initializerf0514 && ($this->initializerf0514->__invoke($valueHolder5f165, $this, 'getMetadataFactory', array(), $this->initializerf0514) || 1) && $this->valueHolder5f165 = $valueHolder5f165;

        return $this->valueHolder5f165->getMetadataFactory();
    }

    public function getExpressionBuilder()
    {
        $this->initializerf0514 && ($this->initializerf0514->__invoke($valueHolder5f165, $this, 'getExpressionBuilder', array(), $this->initializerf0514) || 1) && $this->valueHolder5f165 = $valueHolder5f165;

        return $this->valueHolder5f165->getExpressionBuilder();
    }

    public function beginTransaction()
    {
        $this->initializerf0514 && ($this->initializerf0514->__invoke($valueHolder5f165, $this, 'beginTransaction', array(), $this->initializerf0514) || 1) && $this->valueHolder5f165 = $valueHolder5f165;

        return $this->valueHolder5f165->beginTransaction();
    }

    public function getCache()
    {
        $this->initializerf0514 && ($this->initializerf0514->__invoke($valueHolder5f165, $this, 'getCache', array(), $this->initializerf0514) || 1) && $this->valueHolder5f165 = $valueHolder5f165;

        return $this->valueHolder5f165->getCache();
    }

    public function transactional($func)
    {
        $this->initializerf0514 && ($this->initializerf0514->__invoke($valueHolder5f165, $this, 'transactional', array('func' => $func), $this->initializerf0514) || 1) && $this->valueHolder5f165 = $valueHolder5f165;

        return $this->valueHolder5f165->transactional($func);
    }

    public function wrapInTransaction(callable $func)
    {
        $this->initializerf0514 && ($this->initializerf0514->__invoke($valueHolder5f165, $this, 'wrapInTransaction', array('func' => $func), $this->initializerf0514) || 1) && $this->valueHolder5f165 = $valueHolder5f165;

        return $this->valueHolder5f165->wrapInTransaction($func);
    }

    public function commit()
    {
        $this->initializerf0514 && ($this->initializerf0514->__invoke($valueHolder5f165, $this, 'commit', array(), $this->initializerf0514) || 1) && $this->valueHolder5f165 = $valueHolder5f165;

        return $this->valueHolder5f165->commit();
    }

    public function rollback()
    {
        $this->initializerf0514 && ($this->initializerf0514->__invoke($valueHolder5f165, $this, 'rollback', array(), $this->initializerf0514) || 1) && $this->valueHolder5f165 = $valueHolder5f165;

        return $this->valueHolder5f165->rollback();
    }

    public function getClassMetadata($className)
    {
        $this->initializerf0514 && ($this->initializerf0514->__invoke($valueHolder5f165, $this, 'getClassMetadata', array('className' => $className), $this->initializerf0514) || 1) && $this->valueHolder5f165 = $valueHolder5f165;

        return $this->valueHolder5f165->getClassMetadata($className);
    }

    public function createQuery($dql = '')
    {
        $this->initializerf0514 && ($this->initializerf0514->__invoke($valueHolder5f165, $this, 'createQuery', array('dql' => $dql), $this->initializerf0514) || 1) && $this->valueHolder5f165 = $valueHolder5f165;

        return $this->valueHolder5f165->createQuery($dql);
    }

    public function createNamedQuery($name)
    {
        $this->initializerf0514 && ($this->initializerf0514->__invoke($valueHolder5f165, $this, 'createNamedQuery', array('name' => $name), $this->initializerf0514) || 1) && $this->valueHolder5f165 = $valueHolder5f165;

        return $this->valueHolder5f165->createNamedQuery($name);
    }

    public function createNativeQuery($sql, \Doctrine\ORM\Query\ResultSetMapping $rsm)
    {
        $this->initializerf0514 && ($this->initializerf0514->__invoke($valueHolder5f165, $this, 'createNativeQuery', array('sql' => $sql, 'rsm' => $rsm), $this->initializerf0514) || 1) && $this->valueHolder5f165 = $valueHolder5f165;

        return $this->valueHolder5f165->createNativeQuery($sql, $rsm);
    }

    public function createNamedNativeQuery($name)
    {
        $this->initializerf0514 && ($this->initializerf0514->__invoke($valueHolder5f165, $this, 'createNamedNativeQuery', array('name' => $name), $this->initializerf0514) || 1) && $this->valueHolder5f165 = $valueHolder5f165;

        return $this->valueHolder5f165->createNamedNativeQuery($name);
    }

    public function createQueryBuilder()
    {
        $this->initializerf0514 && ($this->initializerf0514->__invoke($valueHolder5f165, $this, 'createQueryBuilder', array(), $this->initializerf0514) || 1) && $this->valueHolder5f165 = $valueHolder5f165;

        return $this->valueHolder5f165->createQueryBuilder();
    }

    public function flush($entity = null)
    {
        $this->initializerf0514 && ($this->initializerf0514->__invoke($valueHolder5f165, $this, 'flush', array('entity' => $entity), $this->initializerf0514) || 1) && $this->valueHolder5f165 = $valueHolder5f165;

        return $this->valueHolder5f165->flush($entity);
    }

    public function find($className, $id, $lockMode = null, $lockVersion = null)
    {
        $this->initializerf0514 && ($this->initializerf0514->__invoke($valueHolder5f165, $this, 'find', array('className' => $className, 'id' => $id, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializerf0514) || 1) && $this->valueHolder5f165 = $valueHolder5f165;

        return $this->valueHolder5f165->find($className, $id, $lockMode, $lockVersion);
    }

    public function getReference($entityName, $id)
    {
        $this->initializerf0514 && ($this->initializerf0514->__invoke($valueHolder5f165, $this, 'getReference', array('entityName' => $entityName, 'id' => $id), $this->initializerf0514) || 1) && $this->valueHolder5f165 = $valueHolder5f165;

        return $this->valueHolder5f165->getReference($entityName, $id);
    }

    public function getPartialReference($entityName, $identifier)
    {
        $this->initializerf0514 && ($this->initializerf0514->__invoke($valueHolder5f165, $this, 'getPartialReference', array('entityName' => $entityName, 'identifier' => $identifier), $this->initializerf0514) || 1) && $this->valueHolder5f165 = $valueHolder5f165;

        return $this->valueHolder5f165->getPartialReference($entityName, $identifier);
    }

    public function clear($entityName = null)
    {
        $this->initializerf0514 && ($this->initializerf0514->__invoke($valueHolder5f165, $this, 'clear', array('entityName' => $entityName), $this->initializerf0514) || 1) && $this->valueHolder5f165 = $valueHolder5f165;

        return $this->valueHolder5f165->clear($entityName);
    }

    public function close()
    {
        $this->initializerf0514 && ($this->initializerf0514->__invoke($valueHolder5f165, $this, 'close', array(), $this->initializerf0514) || 1) && $this->valueHolder5f165 = $valueHolder5f165;

        return $this->valueHolder5f165->close();
    }

    public function persist($entity)
    {
        $this->initializerf0514 && ($this->initializerf0514->__invoke($valueHolder5f165, $this, 'persist', array('entity' => $entity), $this->initializerf0514) || 1) && $this->valueHolder5f165 = $valueHolder5f165;

        return $this->valueHolder5f165->persist($entity);
    }

    public function remove($entity)
    {
        $this->initializerf0514 && ($this->initializerf0514->__invoke($valueHolder5f165, $this, 'remove', array('entity' => $entity), $this->initializerf0514) || 1) && $this->valueHolder5f165 = $valueHolder5f165;

        return $this->valueHolder5f165->remove($entity);
    }

    public function refresh($entity)
    {
        $this->initializerf0514 && ($this->initializerf0514->__invoke($valueHolder5f165, $this, 'refresh', array('entity' => $entity), $this->initializerf0514) || 1) && $this->valueHolder5f165 = $valueHolder5f165;

        return $this->valueHolder5f165->refresh($entity);
    }

    public function detach($entity)
    {
        $this->initializerf0514 && ($this->initializerf0514->__invoke($valueHolder5f165, $this, 'detach', array('entity' => $entity), $this->initializerf0514) || 1) && $this->valueHolder5f165 = $valueHolder5f165;

        return $this->valueHolder5f165->detach($entity);
    }

    public function merge($entity)
    {
        $this->initializerf0514 && ($this->initializerf0514->__invoke($valueHolder5f165, $this, 'merge', array('entity' => $entity), $this->initializerf0514) || 1) && $this->valueHolder5f165 = $valueHolder5f165;

        return $this->valueHolder5f165->merge($entity);
    }

    public function copy($entity, $deep = false)
    {
        $this->initializerf0514 && ($this->initializerf0514->__invoke($valueHolder5f165, $this, 'copy', array('entity' => $entity, 'deep' => $deep), $this->initializerf0514) || 1) && $this->valueHolder5f165 = $valueHolder5f165;

        return $this->valueHolder5f165->copy($entity, $deep);
    }

    public function lock($entity, $lockMode, $lockVersion = null)
    {
        $this->initializerf0514 && ($this->initializerf0514->__invoke($valueHolder5f165, $this, 'lock', array('entity' => $entity, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializerf0514) || 1) && $this->valueHolder5f165 = $valueHolder5f165;

        return $this->valueHolder5f165->lock($entity, $lockMode, $lockVersion);
    }

    public function getRepository($entityName)
    {
        $this->initializerf0514 && ($this->initializerf0514->__invoke($valueHolder5f165, $this, 'getRepository', array('entityName' => $entityName), $this->initializerf0514) || 1) && $this->valueHolder5f165 = $valueHolder5f165;

        return $this->valueHolder5f165->getRepository($entityName);
    }

    public function contains($entity)
    {
        $this->initializerf0514 && ($this->initializerf0514->__invoke($valueHolder5f165, $this, 'contains', array('entity' => $entity), $this->initializerf0514) || 1) && $this->valueHolder5f165 = $valueHolder5f165;

        return $this->valueHolder5f165->contains($entity);
    }

    public function getEventManager()
    {
        $this->initializerf0514 && ($this->initializerf0514->__invoke($valueHolder5f165, $this, 'getEventManager', array(), $this->initializerf0514) || 1) && $this->valueHolder5f165 = $valueHolder5f165;

        return $this->valueHolder5f165->getEventManager();
    }

    public function getConfiguration()
    {
        $this->initializerf0514 && ($this->initializerf0514->__invoke($valueHolder5f165, $this, 'getConfiguration', array(), $this->initializerf0514) || 1) && $this->valueHolder5f165 = $valueHolder5f165;

        return $this->valueHolder5f165->getConfiguration();
    }

    public function isOpen()
    {
        $this->initializerf0514 && ($this->initializerf0514->__invoke($valueHolder5f165, $this, 'isOpen', array(), $this->initializerf0514) || 1) && $this->valueHolder5f165 = $valueHolder5f165;

        return $this->valueHolder5f165->isOpen();
    }

    public function getUnitOfWork()
    {
        $this->initializerf0514 && ($this->initializerf0514->__invoke($valueHolder5f165, $this, 'getUnitOfWork', array(), $this->initializerf0514) || 1) && $this->valueHolder5f165 = $valueHolder5f165;

        return $this->valueHolder5f165->getUnitOfWork();
    }

    public function getHydrator($hydrationMode)
    {
        $this->initializerf0514 && ($this->initializerf0514->__invoke($valueHolder5f165, $this, 'getHydrator', array('hydrationMode' => $hydrationMode), $this->initializerf0514) || 1) && $this->valueHolder5f165 = $valueHolder5f165;

        return $this->valueHolder5f165->getHydrator($hydrationMode);
    }

    public function newHydrator($hydrationMode)
    {
        $this->initializerf0514 && ($this->initializerf0514->__invoke($valueHolder5f165, $this, 'newHydrator', array('hydrationMode' => $hydrationMode), $this->initializerf0514) || 1) && $this->valueHolder5f165 = $valueHolder5f165;

        return $this->valueHolder5f165->newHydrator($hydrationMode);
    }

    public function getProxyFactory()
    {
        $this->initializerf0514 && ($this->initializerf0514->__invoke($valueHolder5f165, $this, 'getProxyFactory', array(), $this->initializerf0514) || 1) && $this->valueHolder5f165 = $valueHolder5f165;

        return $this->valueHolder5f165->getProxyFactory();
    }

    public function initializeObject($obj)
    {
        $this->initializerf0514 && ($this->initializerf0514->__invoke($valueHolder5f165, $this, 'initializeObject', array('obj' => $obj), $this->initializerf0514) || 1) && $this->valueHolder5f165 = $valueHolder5f165;

        return $this->valueHolder5f165->initializeObject($obj);
    }

    public function getFilters()
    {
        $this->initializerf0514 && ($this->initializerf0514->__invoke($valueHolder5f165, $this, 'getFilters', array(), $this->initializerf0514) || 1) && $this->valueHolder5f165 = $valueHolder5f165;

        return $this->valueHolder5f165->getFilters();
    }

    public function isFiltersStateClean()
    {
        $this->initializerf0514 && ($this->initializerf0514->__invoke($valueHolder5f165, $this, 'isFiltersStateClean', array(), $this->initializerf0514) || 1) && $this->valueHolder5f165 = $valueHolder5f165;

        return $this->valueHolder5f165->isFiltersStateClean();
    }

    public function hasFilters()
    {
        $this->initializerf0514 && ($this->initializerf0514->__invoke($valueHolder5f165, $this, 'hasFilters', array(), $this->initializerf0514) || 1) && $this->valueHolder5f165 = $valueHolder5f165;

        return $this->valueHolder5f165->hasFilters();
    }
    ...
    public static function staticProxyConstructor($initializer)
    {
        ...
        $instance->initializerf0514 = $initializer;
    ...
    protected function __construct(\Doctrine\DBAL\Connection $conn, \Doctrine\ORM\Configuration $config, \Doctrine\Common\EventManager $eventManager)
    {
        ...
        if (! $this->valueHolder5f165) {
            $reflection = $reflection ?? new \ReflectionClass('Doctrine\\ORM\\EntityManager');
            $this->valueHolder5f165 = $reflection->newInstanceWithoutConstructor();
        \Closure::bind(function (\Doctrine\ORM\EntityManager $instance) {
            unset($instance->config, $instance->conn, $instance->metadataFactory, $instance->unitOfWork, $instance->eventManager, $instance->proxyFactory, $instance->repositoryFactory, $instance->expressionBuilder, $instance->closed, $instance->filterCollection, $instance->cache);
        ...
        $this->valueHolder5f165->__construct($conn, $config, $eventManager);
    }

    public function & __get($name)
    {
        $this->initializerf0514 && ($this->initializerf0514->__invoke($valueHolder5f165, $this, '__get', ['name' => $name], $this->initializerf0514) || 1) && $this->valueHolder5f165 = $valueHolder5f165;

        if (isset(self::$publicProperties46b5a[$name])) {
            return $this->valueHolder5f165->$name;
        }

        $realInstanceReflection = new \ReflectionClass('Doctrine\\ORM\\EntityManager');

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder5f165;
    ...
    {
        $this->initializerf0514 && ($this->initializerf0514->__invoke($valueHolder5f165, $this, '__set', array('name' => $name, 'value' => $value), $this->initializerf0514) || 1) && $this->valueHolder5f165 = $valueHolder5f165;
    ...
    {
        $this->initializerf0514 && ($this->initializerf0514->__invoke($valueHolder5f165, $this, '__isset', array('name' => $name), $this->initializerf0514) || 1) && $this->valueHolder5f165 = $valueHolder5f165;
    ...
    {
        $this->initializerf0514 && ($this->initializerf0514->__invoke($valueHolder5f165, $this, '__unset', array('name' => $name), $this->initializerf0514) || 1) && $this->valueHolder5f165 = $valueHolder5f165;
    ...
    {
        $this->initializerf0514 && ($this->initializerf0514->__invoke($valueHolder5f165, $this, '__clone', array(), $this->initializerf0514) || 1) && $this->valueHolder5f165 = $valueHolder5f165;

        $this->valueHolder5f165 = clone $this->valueHolder5f165;
    }

    public function __sleep()
    {
        $this->initializerf0514 && ($this->initializerf0514->__invoke($valueHolder5f165, $this, '__sleep', array(), $this->initializerf0514) || 1) && $this->valueHolder5f165 = $valueHolder5f165;

        return array('valueHolder5f165');
    }
    ...
    {
        $this->initializerf0514 = $initializer;
    }

    public function getProxyInitializer() : ?\Closure
    {
        return $this->initializerf0514;
    }

    public function initializeProxy() : bool
    {
        return $this->initializerf0514 && ($this->initializerf0514->__invoke($valueHolder5f165, $this, 'initializeProxy', array(), $this->initializerf0514) || 1) && $this->valueHolder5f165 = $valueHolder5f165;
    }

    public function isProxyInitialized() : bool
    {
        return null !== $this->valueHolder5f165;
    }

    public function getWrappedValueHolderValue()
    {
        return $this->valueHolder5f165;
    }
}
